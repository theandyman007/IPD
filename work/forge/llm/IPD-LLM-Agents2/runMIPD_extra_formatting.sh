...
##usage
# ./runMIPD_extra_formatting.sh      ## this runs the experiment, prompting for confirmation
# ./runMIPD_extra_formatting.sh -y   ## this skips the confirmation prompt
...
TESTS=(
    ...
    "long_game|episodes=30 rounds=50"
